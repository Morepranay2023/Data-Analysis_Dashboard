...
This project focuses on analyzing the sales data of Vrinda Store for the year 2022 using Microsoft Excel. The objective of the project is to extract meaningful insights from raw data to support business decision-making and improve overall sales performance.
...
- Order Status Analysis to evaluate delivery and cancellation trends
- Top 5 States Analysis to identify high-performing regions
- Age vs Gender Analysis to understand customer demographics
...
## Dashboard 
< a href=" https://github.com/Morepranay2023/Data-Analysis_Dashboard/blob/main/dashboard.png ">
